# RemnaBuy — Telegram‑бот для shftsecure (покупка подписок + админ‑панель)

RemnaBuy превращает Remnawave‑панель в **user‑facing витрину** для **shftsecure**: пользователь покупает подписку → получает конфиг‑ссылку, а администратор управляет инфраструктурой Remnawave в привычном интерфейсе бота.
