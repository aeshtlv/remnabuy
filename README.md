# RemnaBuy — Telegram‑бот для Remnawave (покупка подписок + админ‑панель)

**Languages:** [English](README_EN.md)

RemnaBuy превращает Remnawave‑панель в **user‑facing витрину**: пользователь покупает подписку → получает конфиг‑ссылку, а администратор управляет инфраструктурой Remnawave в привычном интерфейсе бота.
